      ...
      >
        ...
        <div className="flex flex-col gap-[32px]">
          ...
          <div className="flex flex-col gap-[16px]">
            ...
            <div className="flex flex-row gap-[8px] justify-start">
              ...
              />
              <p className="text-[16px]">Ingat akun</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-[32px]">
          ...
          <div className="flex flex-row gap-[4px]">
            <h1 className="text-[#697586]">Belum memiliki akun?</h1>
            <Link href={"/Register"}><p className="text-[#121926] cursor-pointer">Daftar</p></Link>
          </div>
        </div>
      </div>
